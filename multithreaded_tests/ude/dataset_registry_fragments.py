...
def dataset_registry_home(head_template: str, update_endpoint: str, dataset_entries: List[str] = None):
    return f"""
        {head_template}
...
def dataset_card_modal(modal_close_endpoint: str, modal_html_str: str):
    """
...
def dataset_card(data_card_path: str, modal_open_endpoint: str) -> str:
