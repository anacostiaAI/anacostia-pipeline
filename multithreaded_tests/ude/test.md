...
7. Browse to:
```
http://anacostia.local/ged-edap-modelsec/test-container-min-5/anacostia/
```
Note: the slash at the end is very important. Without the slash, the page will not load.
