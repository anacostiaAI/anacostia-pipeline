...
LEAF_ACCESS_LOGGING_CONFIG_1 = {
    "version": 1,
    "disable_existing_loggers": False,
    "formatters": {
        "default": {
            "()": "uvicorn.logging.DefaultFormatter",
            "fmt": "LEAF 1 ACCESS %(asctime)s - %(levelname)s - %(message)s",
            "datefmt": "%Y-%m-%d %H:%M:%S",
        },
    },
    "handlers": {
...
LEAF_ACCESS_LOGGING_CONFIG_2 = {
    "version": 1,
    "disable_existing_loggers": False,
    "formatters": {
        "default": {
            "()": "uvicorn.logging.DefaultFormatter",
            "fmt": "LEAF 2 ACCESS %(asctime)s - %(levelname)s - %(message)s",
            "datefmt": "%Y-%m-%d %H:%M:%S",
        },
    },
    "handlers": {
...
LEAF_ANACOSTIA_LOGGING_CONFIG_1 = {
    "version": 1,
    "disable_existing_loggers": False,
    "formatters": {
        "anacostia_fmt": {
            "format": "LEAF 1 %(asctime)s - %(levelname)s - %(name)s - %(message)s",
            "datefmt": "%Y-%m-%d %H:%M:%S"
        },
        "combined_fmt": {
            "format": "LEAF 1 %(asctime)s - %(levelname)s - %(name)s - %(message)s",
...
LEAF_ANACOSTIA_LOGGING_CONFIG_2 = {
    "version": 1,
    "disable_existing_loggers": False,
    "formatters": {
        "anacostia_fmt": {
            "format": "LEAF 2 %(asctime)s - %(levelname)s - %(name)s - %(message)s",
            "datefmt": "%Y-%m-%d %H:%M:%S"
        },
        "combined_fmt": {
            "format": "LEAF 2 %(asctime)s - %(levelname)s - %(name)s - %(message)s",
